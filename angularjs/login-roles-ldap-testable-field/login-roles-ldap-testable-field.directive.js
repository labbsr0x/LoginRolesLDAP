 ...
 *
 * <div piwik-piwik-login-roles-ldap-testable-field>
 */
(function () {
    angular.module('piwikApp').directive('piwikLoginRolesLdapTestableField', piwikLoginRolesLdapTestableField);

    piwikLoginRolesLdapTestableField.$inject = ['piwik', 'piwikApi', "$compile"];

    function piwikLoginRolesLdapTestableField(piwik, piwikApi, $compile) {
        return {
            restrict: 'A',
            scope: {
                value: '@',
            ...
            templateUrl: 'plugins/LoginRolesLdap/angularjs/login-roles-ldap-testable-field/login-roles-ldap-testable-field.directive.html?cb=' + piwik.cacheBuster,
