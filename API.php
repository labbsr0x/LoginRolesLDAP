...
class API extends \Piwik\Plugin\API
{
    ...
    public function getCountOfUsersMatchingFilter($filter)
    {
        ...
        try {
            ...
            if (stripos($ex->getMessage(), "Bad search filter") !== false) {
                throw new Exception(Piwik::translate("LoginRolesLdap_InvalidFilter"));
            } else {
                throw $ex;
            }
        }
    ...
    public function synchronizeUser($login)
    {
        ...
        if (empty($ldapUser)) {
            throw new Exception(Piwik::translate('LoginRolesLdap_UserNotFound', $login));
        }
