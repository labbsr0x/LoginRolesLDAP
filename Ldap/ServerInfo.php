 ...
 */
namespace Piwik\Plugins\LoginRolesLdap\Ldap;

use Exception;
use Piwik\Plugins\LoginRolesLdap\Config;

/**
 * Describes an LDAP server LoginRolesLdap can connect to.
 */
class ServerInfo
{
    ...
    /**
     * Creates a ServerInfo instance from an array of old LoginRolesLdap config data.
     *
     * @return ServerInfo
     */
     ...
     * The INI config section's name is determined by prefixing `'LoginRolesLdap_'` to the
     * server name.
     *
     ...
     *                     used in the `[LoginRolesLdap] servers[] = ` config option to
     *                     add an LDAP server to the list of servers LoginRolesLdap will
     *                     connect to.
     * @return ServerInfo
    ...
    public static function saveServerConfig($serverInfo, $forceSave = true)
    {
        ...
        $configSectionName = 'LoginRolesLdap_' . $serverInfo['name'];
