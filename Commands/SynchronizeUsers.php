 ...
 */
namespace Piwik\Plugins\LoginRolesLdap\Commands;

use Exception;
use Piwik\Plugin\ConsoleCommand;
use Piwik\Plugins\LoginRolesLdap\API as LoginRolesLdapAPI;
...
{
    /**
     * @var LoginRolesLdapAPI
     */
    private $loginRolesLdapAPI;
    ...
    public function __construct($name = null)
    {
        ...
        $this->loginRolesLdapAPI = LoginRolesLdapAPI::getInstance();
    ...
    {
        $this->setName('loginrolesldap:synchronize-users');
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        foreach ($logins as $login) {
            ...
            try {
                $this->loginRolesLdapAPI->synchronizeUser($login);
