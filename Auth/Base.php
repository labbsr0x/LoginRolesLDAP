 ...
 */
namespace Piwik\Plugins\LoginRolesLdap\Auth;
...
use Piwik\Plugins\LoginRolesLdap\LdapInterop\UserSynchronizer;
use Piwik\Plugins\LoginRolesLdap\Model\LdapUsers;
use Piwik\Plugins\UsersManager\API as UsersManagerAPI;
use Piwik\Plugins\UsersManager\Model as UserModel;
use Psr\Log\LoggerInterface;

/**
 * Base class for LoginRolesLdap authentication implementations.
 */
abstract class Base implements Auth
{
    ...
    /**
     * Authentication module's name, e.g., "LoginRolesLdap"
     *+
     * @return string
     */
    public function getName()
    {
        return 'LoginRolesLdap';
    }
    ...
    private function checkLdapFunctionsAvailable()
    {
        if (!function_exists('ldap_connect')) {
            throw new Exception(Piwik::translate('LoginRolesLdap_LdapFunctionsMissing'));
        }
    }

    /**
     * Returns the authentication implementation to use in LoginRolesLdap based on certain
