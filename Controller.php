...
class Controller extends \Piwik\Plugins\Login\Controller
{
    ...
    public function admin()
    {
        ...
        $view = new View('@LoginRolesLdap/index');

        ControllerAdmin::setBasicVariablesAdminView($view);

        if (!function_exists('ldap_connect')) {
            $notification = new Notification(Piwik::translate('LoginRolesLdap_LdapFunctionsMissing'));
            $notification->context = Notification::CONTEXT_ERROR;
            $notification->type = Notification::TYPE_TRANSIENT;
            $notification->flags = 0;
            Notification\Manager::notify('LoginRolesLdap_LdapFunctionsMissing', $notification);
        }
        ...
        $view->updatedFromPre30 = Option::get('LoginRolesLdap_updatedFromPre3_0');
