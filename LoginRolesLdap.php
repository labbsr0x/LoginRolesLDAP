 ...
 */
namespace Piwik\Plugins\LoginRolesLdap;
...
use Piwik\Plugins\LoginRolesLdap\Auth\Base as AuthBase;
use Piwik\Plugins\LoginRolesLdap\LdapInterop\UserMapper;
...
/**
 *
 * @package LoginRolesLdap
 */
class LoginRolesLdap extends \Piwik\Plugin
{
    /**
     * @return array
     */
    public function registerEvents()
    {
        $hooks = array(
            ...
            'Controller.LoginRolesLdap.resetPassword'     => 'disablePasswordResetForLdapUsers',
    ...
    public function getJsFiles(&$jsFiles)
    {
        ...
        $jsFiles[] = "plugins/LoginRolesLdap/angularjs/admin/admin.controller.js";
        $jsFiles[] = "plugins/LoginRolesLdap/angularjs/login-roles-ldap-testable-field/login-roles-ldap-testable-field.directive.js";
    }
    ...
    public function getStylesheetFiles(&$stylesheetFiles)
    {
        ...
        $stylesheetFiles[] = "plugins/LoginRolesLdap/angularjs/admin/admin.controller.less";
        $stylesheetFiles[] = "plugins/LoginRolesLdap/angularjs/login-roles-ldap-testable-field/login-roles-ldap-testable-field.directive.less";
    }

    public function getClientSideTranslationKeys(&$keys)
    {
        $keys[] = "General_NUsers";
        $keys[] = "LoginRolesLdap_OneUser";
        $keys[] = "LoginRolesLdap_MemberOfCount";
        $keys[] = "LoginRolesLdap_FilterCount";
        $keys[] = "LoginRolesLdap_Test";
        $keys[] = "General_NUsers";
    }
    ...
    public function disableConfirmResetPasswordForLdapUsers()
    {
        ...
        if ($this->isUserLdapUser($login)) {
            ...
            $errorMessage = Piwik::translate("LoginRolesLdap_UnsupportedPasswordReset");
            echo FrontController::getInstance()->dispatch('LoginRolesLdap', 'login', array($errorMessage));
    ...
    public function noAccess(Exception $exception)
    {
        ...
        echo FrontController::getInstance()->dispatch('LoginRolesLdap', 'login', array($exceptionMessage));
    }
    ...
    public function disablePasswordChangeForLdapUsers(Auth $auth)
    {
        if ($this->isCurrentUserLdapUser($auth)) {
            throw new Exception(
                Piwik::translate('LoginRolesLdap_LdapUserCantChangePassword')
            );
        }
    }
