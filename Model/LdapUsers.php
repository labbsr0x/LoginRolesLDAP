 ...
 */
namespace Piwik\Plugins\LoginRolesLdap\Model;

use Piwik\Container\StaticContainer;
use Piwik\Db;
use Piwik\Piwik;
use Piwik\Plugins\LoginRolesLdap\Config;
use Piwik\Plugins\LoginRolesLdap\LdapInterop\UserMapper;
use Piwik\Plugins\LoginRolesLdap\Ldap\Client as LdapClient;
use Piwik\Plugins\LoginRolesLdap\Ldap\ServerInfo;
use Piwik\Plugins\LoginRolesLdap\Ldap\Exceptions\ConnectionException;
...
class LdapUsers
{
     ...
     * @var string
     */
    private $ldapClientClass = "Piwik\\Plugins\\LoginRolesLdap\\Ldap\\Client";
    ...
    private function throwCouldNotConnectException()
    {
        if (count($this->ldapServers) > 1) {
            $message = Piwik::translate('LoginRolesLdap_CannotConnectToServers', count($this->ldapServers));
        } else {
            $message = Piwik::translate("LoginRolesLdap_CannotConnectToServer");
        }
