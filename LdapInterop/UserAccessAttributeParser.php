 ...
 */
namespace Piwik\Plugins\LoginRolesLdap\LdapInterop;
 ...
 *
 * If you want to use a specific name, you would have to set the `[LoginRolesLdap] instance_name`
 * INI config option for each of your Piwik instances.
 *
 * _Note: If identifying by URLs with port values, the `[LoginRolesLdap] user\_access\_attribute\_server\_separator`
