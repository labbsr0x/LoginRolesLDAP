 ...
 *
 */
namespace Piwik\Plugins\LoginRolesLdap\tests\Unit;
 ...
 * @group LoginRolesLdap_Unit
 * @group LoginRolesLdap_UserSynchronizerTest
 */
class UserSynchronizerTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $mock = $this->getMockBuilder('Piwik\Plugins\LoginRolesLdap\LdapInterop\UserMapper')
    ...
    {
        $mock = $this->getMockBuilder('Piwik\Plugins\LoginRolesLdap\LdapInterop\UserAccessMapper')
