 ...
 *
 */
namespace Piwik\Plugins\LoginRolesLdap\tests\Integration\Commands;
 ...
 * @group LoginRolesLdap_SynchronizeUsersTest
 */
class SynchronizeUsersTest extends LdapIntegrationTest
{
    ...
    public function setUp()
    {
        ...
        $plugins['Plugins'][] = 'LoginRolesLdap';
    ...
    public function test_CommandSynchronizesAllUsers_WhenLoginNotSpecified()
    {
        $result = $this->applicationTester->run(array(
            'command' => 'loginrolesldap:synchronize-users',
            '-v' => true
        ));
