 ...
 * @group LoginRolesLdap_SynchronizedAuthTest
 */
class SynchronizedAuthTest extends LdapIntegrationTest
{
    public function setUp()
    {
        ...
        Config::getInstance()->LoginRolesLdap_brokenserver = array(
            'hostname' => "localhost",
            'port' => 999,
    ...
    {
        Config::getInstance()->LoginRolesLdap['servers'] = array('brokenserver');
    ...
    {
        Config::getInstance()->LoginRolesLdap['synchronize_users_after_login'] = 0;
