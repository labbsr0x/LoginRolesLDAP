 ...
 * @group LoginRolesLdap_LdapUserSynchronizationTest
 */
class LdapUserSynchronizationTest extends LdapIntegrationTest
{
    ...
    {
        Config::getInstance()->LoginRolesLdap['append_user_email_suffix_to_username'] = 0;
        Config::getInstance()->LoginRolesLdap['user_email_suffix'] = '@matthers.com';
    ...
    {
        Config::getInstance()->LoginRolesLdap['new_user_default_sites_view_access'] = 'all';
    ...
    {
        Config::getInstance()->LoginRolesLdap['instance_name'] = 'myPiwik';
    ...
    public function test_AdminAndViewAccessSynchronized_WhenLdapAccessInfoPresent_AndInstancePiwikUrlUsed()
    {
        ...
        Config::getInstance()->LoginRolesLdap['ldap_superuser_access_field'] = 'isasuperuser'; // disable superuser check so we can check user's normal access
    ...
    {
        Config::getInstance()->LoginRolesLdap['user_email_suffix'] = '@xmansion.org';
    ...
    {
        Config::getInstance()->LoginRolesLdap['enable_synchronize_access_from_ldap'] = 1;
    }
