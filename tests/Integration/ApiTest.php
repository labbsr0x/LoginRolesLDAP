...
use Exception;
use Piwik\Config;
use Piwik\Plugins\LoginRolesLdap\API;

/**
 * @group LoginRolesLdap
 * @group LoginRolesLdap_Integration
 * @group LoginRolesLdap_ApiTest
 */
class ApiTest extends LdapIntegrationTest
{
     ...
     * @expectedExceptionMessage LoginRolesLdap_InvalidFilter
     */
    ...
    public function test_saveLdapConfig_SavesConfigToINIFile_AndIgnoresInvalidConfigNames()
    {
        ...
        Config::getInstance()->LoginRolesLdap['servers'] = array();
        ...
        $ldapConfig = Config::getInstance()->LoginRolesLdap;
    ...
    public function test_saveServersInfo_SavesConfigToINIFile_AndIgnoresInvalidServerInfo()
    {
        ...
        $this->assertEquals(array(
            ...
            'admin_user' => null,
            'admin_pass' => null
        ), Config::getInstance()->LoginRolesLdap_server1);
        ...
        $this->assertEquals(array(
            ...
            'admin_user' => 'admin',
            'admin_pass' => 'pass'
        ), Config::getInstance()->LoginRolesLdap_server2);
    }
    ...
    public function test_saveServersInfo_DoesNotOverwritePassword_IfPasswordFieldBlank()
    {
        ...
        Config::getInstance()->LoginRolesLdap_server2 = array(
            'hostname' => 'thehost.com',
            'port' => 456,
            'base_dn' => 'thedn',
            'admin_user' => 'admin',
    ...
    /**
     * @expectedException Exception
     * @expectedExceptionMessage LoginRolesLdap_UserNotFound
     */
