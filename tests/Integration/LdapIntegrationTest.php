...
use Piwik\Db;
use Piwik\Config;
use Piwik\Plugins\LoginRolesLdap\Ldap\LdapFunctions;
use Piwik\Plugins\LoginRolesLdap\LdapInterop\UserMapper;
use Piwik\Tests\Framework\Fixture;
use Piwik\Plugins\UsersManager\API as UsersManagerAPI;
use Piwik\Tests\Framework\TestCase\IntegrationTestCase;

require_once PIWIK_INCLUDE_PATH . '/plugins/LoginRolesLdap/tests/Mocks/LdapFunctions.php';
...
abstract class LdapIntegrationTest extends IntegrationTestCase
{
    ...
    public function setUp()
    {
        ...
        Config::getInstance()->LoginRolesLdap = Config::getInstance()->LoginRolesLdapTest + array(
            'servers' => 'testserver',
        ...
        Config::getInstance()->LoginRolesLdap_testserver = Config::getInstance()->LoginRolesLdap_testserver + array(
